...
jQuery(document).ready(function ($) {
    ...
    $('select[name="beacon_settings[display_type]"]').change(function () {
        ...
        if (selectedItem.val() === 'popover') {
            $('select[name="beacon_settings[display_type]"]').closest('tr').next('tr').css('display', 'table-row');
            ...
            $('select[name="beacon_settings[display_type]"]').closest('tr').next('tr').css('display', 'none');
